...
def get_distance_matrix(dist_filepath = 'distances.txt'):
    '''
...
class IDASearchEngine:
    ...
    def search(self, initState, goal_fn, ss, heur_fn=_zero_hfn, LIMIT=1):
        ...
        n1=sNode(initState, heur_fn(initState))
        ...
        ###Step 7: NOW peform the search by calling searchOpen and return the result as Node in search space.
            #(1 line)
        goal_node = self.searchOpen(op, goal_fn, heur_fn, ss, LIMIT, initState)
        ...
        if goal_node:
            ...
            if LIMIT < len(initState.locations):
                ...
                #NOTE: In IDA* search, the limit of the search is incremented by the next smallest f(n) value beyond the current search limit.
                #HOWEVER, due to the LIMIT==DEPTH evalution on line 551, here I increment LIMIT by 1 to maintain the same units as DEPTH for comparison.
                LIMIT += 1
    ...
    def searchOpen(self, OPEN, goal_fn, heur_fn, ss, LIMIT, initState):
        ...
        while not OPEN.empty():
            ...
            for succ in successors:
                ...
                # (1-2 lines)
                prune_succ=0
                if hash_state in self.cc_dictionary and self.cc_dictionary[hash_state]<succ.gval:
                    prune_succ = 1
...
if __name__ == '__main__':
    dist_filepath =  'C:/Users/audre/OneDrive/Documents/CMU/Fall_2020/Intro_to_AI/assignment_1/distances.csv' #Enter path to distances.csv file
    loc_filepath = 'C:/Users/audre/OneDrive/Documents/CMU/Fall_2020/Intro_to_AI/assignment_1/locations.txt' #Enter path to locations.tst file
